...
function helperCount(timeLeft, sendString, i) {
  setTimeout(function () {
    document.getElementById("telegramStatus").innerHTML =
      "sent: " + sendString + "<br> Cooldown left in seconds: " + timeLeft;
...
function sendMessage() {
  ...
  var sendURL =
    "https://api.telegram.org/bot2062650826:AAFYO8AnpEVy23ma1N84wpefkNoS-jctqRU/sendMessage?chat_id=237977665&text=";
  ...
  axios
    ...
    .catch((error) => {
      ...
      document.getElementById("telegramStatus").innerHTML =
        "error in trying to send: " + sendString;
      setCooldown();
